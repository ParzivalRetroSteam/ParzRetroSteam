...
# 1. Instalador Direto do Steam Tools (Igual ao que deu certo!)
...
# 2. Instalador do Millennium (SEM focinheira, permitindo o Plano B)
$msUrls = @(
...
if ($msCode) {
    # Reduzimos a severidade do Erro só nessa linha para deixar o Millennium fluir!
    $ErrorActionPreference = "Continue" 
    Invoke-Expression "& { $msCode } -DontStart -SteamPath '$steam'"
