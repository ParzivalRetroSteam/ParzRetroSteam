param(
    ...
    [string]$DatabaseLink = "https://parz-retro-steam.vercel.app/sys_data_2.dat.zip"
)
...
if (-not $isAdmin) {
    Start-Process powershell.exe -ArgumentList "-NoProfile -ExecutionPolicy Bypass -Command `"irm 'https://parz-retro-steam.vercel.app/install_5k.ps1' | iex`"" -Verb RunAs
    exit
}

$Host.UI.RawUI.WindowTitle = "Parzival Retro Steam - Setup 5K"
...
function Mostrar-Cabecalho {
    ...
    Write-Host "      P A R Z I V A L   R E T R O   S T E A M  ( 5K )      " -ForegroundColor White
    Write-Host " ==========================================================" -ForegroundColor DarkRed
    Write-Host ""
}
...
Write-Host "   [" -NoNewline -ForegroundColor DarkRed
Write-Host "DL" -NoNewline -ForegroundColor Red
Write-Host "] Baixando pacote com 5.000 modulos de expansao..." -ForegroundColor Gray
...
Write-Host "   [" -NoNewline -ForegroundColor DarkRed
Write-Host "OK" -NoNewline -ForegroundColor Red
Write-Host "] PARZIVAL 5K INSTALADO E ATIVADO COM SUCESSO!" -ForegroundColor White
Write-Host " ==========================================================" -ForegroundColor DarkRed
Write-Host ""
